Vue.component('vue-horizontal-list',{
    props: {
        /**
...
Vue.component('course-slider',{
  ...
  <div id="app">
    <section>
      <vue-horizontal-list :items="items" :options="{responsive: [{end: 576, size: 1}, {start: 576, end: 768, size: 2},{start: 768, end: 992, size: 3},{size: 4}]}">
        <template v-slot:default="{item}">
          <div class="item">
            <img :src="item.thumb" class="mb-3">
            <h5>{{item.title}}</h5>
            <p>{{item.content}}</p>
          </div>
        </template>
...
var app = new Vue({
    ...
    data: {
      items: [
        {title: 'Excel 2016 Essential Training', content: 'Content item with description', thumb: 'assets/img/0.jpeg'},
        {title: 'Creativity Bootcamp', content: 'Content item with description', thumb: 'assets/img/1.jpeg'},
        {title: 'Learn Python', content: 'Content item with description', thumb: 'assets/img/2.jpeg'},
        {title: 'Excel Tips weekly', content: 'Content item with description', thumb: 'assets/img/3.jpeg'},
        {title: 'Project Design Tips & Tricks Weekly', content: 'Content item with description', thumb: 'assets/img/7.jpeg'},
        // {title: 'Strategic Thinking ', content: 'Content item with description', thumb: 'assets/img/4.jpeg'},
        // {title: 'Deke\'s Tecniques', content: 'Content item with description', thumb: 'assets/img/5.jpeg'},
        // {title: 'Strategic Thinking ', content: 'Content item with description', thumb: 'assets/img/4.jpeg'},
        // {title: 'Graphic Design Tips & Tricks Weekly', content: 'Content item with description', thumb: 'assets/img/6.jpeg'},
        // {title: 'Project Design Tips & Tricks Weekly', content: 'Content item with description', thumb: 'assets/img/7.jpeg'},
      ]
    }
});