Vue.component('course',{
    props: ['thumb','name','views'],
    template: '<div><img :src="thumb"><p>{{ name }} with {{ views }} views</p></div>'
});

Vue.component('slider',{
    template: `
        <div class="carousel">
            <course v-for="course in courses" :key="course.id" :thumb="course.thumb" :views="course.views" :name="course.name">
                {{ course.thumb }}
            </course>
        </div>`,
    data() {
        return {
            courses: [
                { id: '1', name: 'Excel 2016 Essential Training', views: '613,036', thumb: 'http://lorempixel.com/200/200/nature/'},
                { id: '2', name: 'Creativity Bootcamp', views: '613,036', thumb: 'http://lorempixel.com/200/200/fashion/'},
                { id: '3', name: 'Learn Python', views: '613,036', thumb: 'http://lorempixel.com/200/200/sports/'},
                { id: '4', name: 'Excel Tips weekly', views: '613,036', thumb: 'http://lorempixel.com/200/200/animal/'},
                { id: '5', name: 'Strategic Thinking ', views: '613,036', thumb: 'http://lorempixel.com/200/200/abstract/'},
                { id: '6', name: 'Deke\'s Tecniques', views: '613,036', thumb: 'http://lorempixel.com/200/200/people/'},
                { id: '7', name: 'Graphic Design Tips & Tricks Weekly', views: '114,932', thumb: 'http://lorempixel.com/200/200/sports/'},
                { id: '8', name: 'Excel 2016 Essential Training', views: '114,932', thumb: 'http://lorempixel.com/200/200/nature/'},
            ]
        }
    },
});

Vue.component('VueHorizontalList',{
    props: {
